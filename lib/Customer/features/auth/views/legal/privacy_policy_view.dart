          ...
          children: [
            ...
            _SectionCard(
              ...
              bullets: const [
                ...
                'الموقع الجغرافي (بموافقتك) لعرض الحرفيين الأقرب وتحسين النتائج.',
                'بيانات الجهاز والاستخدام مثل نوع الجهاز ونظام التشغيل وعناوين IP (لتحسين الأداء والحماية).',
                'محتوى المراسلات/البلاغات داخل التطبيق عند استخدام الدردشة أو الشكاوى.',
              ],
            ),
            ...
            _SectionCard(
              ...
              bullets: const [
                ...
                'قد نشارك الحد الأدنى اللازم لتنفيذ الخدمة (مثل مشاركة الموقع وبيانات الطلب مع الحرفي).',
                'قد نشارك بيانات مع مزودي خدمات تقنيين (استضافة/إشعارات) لتشغيل التطبيق بشكل آمن.',
            ...
            _SectionCard(
              ...
              bullets: const [
                ...
                'طلب حذف الحساب/البيانات وفقًا للمتطلبات القانونية والتشغيلية.',
